...
- ✅ **v1.1 Folder Navigation** — Phase 1 (shipped 2026-04-15) — see `.planning/milestones/v1.1-ROADMAP.md`
...
<details>
<summary>✅ v1.1 Folder Navigation (Phase 1) — SHIPPED 2026-04-15</summary>

- [x] Phase 1: Folder Navigation — `--folder` flag for search and digest (2/2 plans) — completed 2026-04-15
