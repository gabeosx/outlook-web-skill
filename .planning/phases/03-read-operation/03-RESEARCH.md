...
**What goes wrong:** Extracting all accessible names from `document "Message body"` children gives a mix of link labels (`"Donate"`, `"Schedule an HIV/STI Test"`) and actual prose sentences — the result is not clean prose.
