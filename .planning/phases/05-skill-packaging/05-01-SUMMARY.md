...
4. **Fictional examples** — "Smith, Alice", "alice@example.com", "Bob Jones", "Q1 Budget Review" are all invented. No real user data (per T-05-05 mitigation). "Bob Jones" accepted per T-05-03 (fictional example in schema).
...
- No real user data (accenture domains): PASS
