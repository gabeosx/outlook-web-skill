...
- **Issue:** Channel and group notification senders (e.g., "[Internal Newsletter]", "[Internal Newsletter]") were not caught by the bulk regex but also should not trigger full +40 unread bonus
