...
T-06-12 mitigated: All JSON examples in SKILL.md use synthetic data (example.com domains, generic names "Smith, Alice", "Jones, Bob"). No real user data in documentation.
