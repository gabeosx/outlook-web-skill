...
- What is the accessible name format? (e.g., "Mon Apr 14 9:00 AM – 10:00 AM Team Standup Alice Smith Recurring Online")
...
3. **How does Outlook Calendar URL routing work on this tenant?**
   - What we know: Mail URL is `https://myemail.accenture.com/mail/` (after load). Calendar button exists in nav.
