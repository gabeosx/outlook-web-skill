...
agent-browser fill @e1 "[REDACTED_EMAIL]"
...
agent-browser fill @e1 "[REDACTED_EMAIL]" && agent-browser fill @e2 "password123" && agent-browser click @e3
...
agent-browser batch "fill @e1 \"Jane Doe\"" "fill @e2 \"[REDACTED_EMAIL]\"" "select @e3 \"California\"" "check @e4" "click @e5" "wait 2000"
```
...
agent-browser find label "Email" fill "[REDACTED_EMAIL]"
