...
# Debug only
## Sources
- `/Users/[REDACTED_USER]/outlook-web-skill/.agents/skills/agent-browser/SKILL.md` — agent-browser CLI reference (direct inspection, HIGH confidence)
- `/Users/[REDACTED_USER]/outlook-web-skill/.agents/skills/agent-browser/references/authentication.md` — auth patterns (direct inspection, HIGH confidence)
- `/Users/[REDACTED_USER]/outlook-web-skill/.agents/skills/agent-browser/references/session-management.md` — session patterns (direct inspection, HIGH confidence)
- `/Users/[REDACTED_USER]/outlook-web-skill/.planning/PROJECT.md` — requirements and constraints (direct inspection, HIGH confidence)
